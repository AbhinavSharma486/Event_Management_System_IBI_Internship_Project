...
const RegisterPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-cyan-400 via-purple-400 to-blue-400 pt-30 pb-10 px-4 sm:px-6 lg:px-8">
      <motion.div
      ...
      >
        ...
        >
          {/* Header moved inside the form card */}
